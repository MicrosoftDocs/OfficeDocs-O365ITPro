...
![Administrative Opt-in Settings for the New Yammer Preview](../media/yammer-admin-settings-newyammer.png)
...
![New Yammer Preview Opt-in Toggle](../media/yammer-optin-admin-settings.png)
