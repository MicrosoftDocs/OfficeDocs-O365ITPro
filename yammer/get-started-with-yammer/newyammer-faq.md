...
As Microsoft’s first app built from the ground up with the Fluent Design System, the new Yammer provides an engaging and easy-to-use experience on the web and in the Yammer app for Android and iOS. In addition, Yammer can be integrated with Microsoft Teams, as a Communities app in the left rail, enabling you to access organization-wide communities without leaving the hub for teamwork. Integration with Outlook lets you read, like, and reply to Yammer conversations within your Outlook inbox. And the Yammer Conversations web part for SharePoint Online introduces Yammer’s new design and features, including questions and answers, to power a social intranet.  
