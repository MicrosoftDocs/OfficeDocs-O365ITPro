...
- Yammer admins, verified admins, and global admins can bring extra attention to a conversation by featuring it for the network.  
...
We are working hard to bring new features and continuous improvements to new Yammer. Below is a list of features that differ or where further improvements are being explored:
...
- Microsoft 365 and Office 365 resources discoverability
- Some network admin features in communities pages
...
- Cannot see followers or who is following on people page
...
- **Does the issue only occur for the new Yammer?** Or, does it also occur with the classic user experience too?
