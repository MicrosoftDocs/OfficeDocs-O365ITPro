...
>[!NOTE] 
>External messaging, including exernal networks, external groups, and external participants, is not available for Yammer Enterprise networks in the [EU Geo](../manage-security-and-compliance/data-residency-eu-geo.md).
