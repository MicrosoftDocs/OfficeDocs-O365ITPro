...
- Navigate to **Connectors** on the left navigation bar. Select **New Connector** on the top right of the page. 
    
    ![Create a Kaizala connector.](media/fd2b88b1-3260-4392-81b9-d2b8e1ba40db.png)
  
- On the New Connector page, enter a **Connector Name** and a short description for the connector. Select or tap **Create**.
