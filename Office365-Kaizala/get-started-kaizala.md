...
|                         |                          |
|-------------------------|--------------------------|
|[![Image of Bring Everyone Together](media/bring-everyone-together-1.png)](bring-everyone-together.md) | **[Bring everyone together](bring-everyone-together.md)** <br> Build a company-wide **phone directory** and enable all your employees to discover and connect with anyone in the organization. |
...
|[![Image of Connect with Employees](media/connect-with-employees-1.png)](connect-with-employees.md) | **[Connect with employees](connect-with-employees.md)** <br> Create **company connect** groups and extend corporate communication by sharing announcements and collecting feedback with entire external networks.  |[![Image of Digitize Everyday Tasks](media/digitize-everyday-tasks-1.png)](digitize-tasks.md) | **[Digitize everyday tasks](digitize-tasks.md)** <br> Use **Kaizala Actions** to digitize processes such as field data collection, attendance, trainings, surveys, and many more.      |
