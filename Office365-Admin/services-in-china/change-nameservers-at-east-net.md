...
Follow these instructions if you want Office 365 operated by 21Vianet to manage your Office 365 DNS records for you. (If you prefer, you can [manage all your DNS records at east.net](create-dns-records-at-east-net.md).)
  
Here's what you need to do:
  
- [Add a TXT record to verify that you own the domain](change-nameservers-at-east-net.md#BKMK_add_a_record)
    
- [Change your domain's name servers](change-nameservers-at-east-net.md#BKMK_change_your_domain_s_1)
