...
Group owners will only be notified via email. Even if the group was created via Planner or SharePoint, or any other app except for Teams the expiration notifications will always come via email.If the group was created via Teams the group owner will receive a notification to renew through the activity section. It's not recommended to enable expiration on a group if your group owner doesn't have a valid email address.
