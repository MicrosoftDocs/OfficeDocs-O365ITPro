...
> [!NOTE]
> You can check for problems with your domain by checking its status. Go to **Settings** > **Domains** and view the notifications in the **Status** column. If you see an issue, select More actions (three dots), and then choose **Check health**. The pane the opens will describe any issues occurring with your domain.
