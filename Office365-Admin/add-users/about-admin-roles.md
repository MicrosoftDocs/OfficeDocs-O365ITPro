...
> [!TIP]
> For a detailed list of permission for each of these roles, go to **Roles** > **Roles**, select a role, and then the **Permissions** tab. 
...
## Admin roles
Here are the roles that are available in the Microsoft 365 admin center. To see more detailed information about these roles, go to Roles > Roles, select a role, and then you can find a detailed description on the General tab and a complete list of permissions on the Permissions tab.

|||
|:-----|:-----|
|**Role** <br/> |**Has access to** <br/> |
|**Global admin** <br/> |Access to all admin features and most data for the Office 365 and Microsoft 365 suite of services in your plan, including Teams and Skype for Business. By default, the person who signed up to buy    <br/><br/> **Tip:** Make sure everyone who is a global admin in your organization has a mobile phone number and alternate email address in their contact info. Check out [Change your organization's address, technical contact email, and other information](../manage/change-address-contact-and-more.md) for more details.  <br/> |
...
If you have a large business, you'll want to there might be roles in Azure Active Directory that will meet your organizational needs. A user who is assigned an admin role will have the same permissions across all of the cloud services that your organization has subscribed to, regardless of whether you assign the role in the Microsoft 365 admin center, or in the Azure classic portal, or by using the Azure AD module for Windows PowerShell.
