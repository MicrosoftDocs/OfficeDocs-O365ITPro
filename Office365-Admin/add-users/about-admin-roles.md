...
|![Reporting reader admin](../media/9370edc6-4a93-48d3-b829-c826db15813a.png) **Reports reader** <br/> |Can view all the [activity reports](../activity-reports/activity-reports.md) in the admin center and any reports exposed through the reporting APIs.  <br/><br/> This role has no access to view, create, or manage support tickets. <br/> |
