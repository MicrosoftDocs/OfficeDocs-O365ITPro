...
1. Sign in to Microsoft 365 at [office.com](https://www.office.com/) with the account that has [admin permissions](../add-users/about-admin-roles.md).
    
    ::: moniker range="o365-germany"

    If you're using Office 365 Germany, [sign in here](https://portal.office.de/) with your admin account. 

    ::: moniker-end

    ::: moniker range="o365-21vianet"

    If you're using Office 365 operated by 21Vianet, [sign in to Office 365 operated by 21Vianet](https://login.partner.microsoftonline.cn) with your admin account. 
...
- Manage Office 365 groups: [Create and manage groups](../create-groups/create-groups.md)
