...
Each month you'll receive an email that tells you that your new billing statement is available in the Office 365 admin center. [Learn how to find and view your bill or invoice](view-your-bill-or-invoice.md).
...
|**Name**|**Description**|
|:-----|:-----|
|Annual Price|Subscriptions are billed monthly or annually. If you selected annual billing during the subscription purchase, the annual license price is reflected on the invoice. If you want to change the billing frequency, you'll have to cancel your subscription and repurchase it with the new billing frequency.|
...
|Bill-To|This is the address of your billing department, and is usually the same as the Sold-To address. To update your billing address, see [Change your billing addresses for Office 365 for business](change-your-billing-addresses.md).|
...
|Service Usage Address|The address where the service is being used, usually the same as your Sold-To address. To update your Service Usage Address, see [Change your billing addresses for Office 365 for business](change-your-billing-addresses.md).|
...
|Tax|Page 1 of your invoice shows the total tax. Page 2 shows the tax rate applied, and the total tax amount for each line item. If your invoice contains taxes and your company is tax exempt, please [Contact support for business products - Admin Help](../contact-support-for-business-products.md).|
