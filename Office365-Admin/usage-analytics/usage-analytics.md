...
It is not free, you will need a Power BI Pro license. For details see [prerequisites](https://docs.microsoft.com/en-us/power-bi/service-template-apps-install-distribute#prerequisites) for installing, customizing, and distributing a template app.
