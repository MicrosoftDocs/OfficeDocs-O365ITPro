...
|:-----|
|**Who can customize the Microsoft 365 usage analytics dashboards and reports?**|
|:-----|
|**Can I only customize the dashboards and reports in Microsoft 365 usage analytics from the Power BI web interface?**|
|:-----|
|**How can I get the pbit file that this dashboard is associated with?**|
|:-----|
|**Who can view the dashboards and reports in Microsoft 365 usage analytics?**|
|:-----|
...
[Troubleshoot Microsoft 365 usage analytics](usage-analytics-errors.md)
