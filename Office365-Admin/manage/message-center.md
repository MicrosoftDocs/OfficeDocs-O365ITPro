...
Message center presents a view of all active messages in a table format, by default showing the most recent message at the top of the list. You can select a tab to see **All active messages**, **High importance**, **Unread messages**, and **Dismissed messages**. Here's a quick overview of the information you'll see in each column. Select any of the column headings to change the sort order.
...
|More options <br/> |More options lets you dismiss a message, mark it as read, or share it with another admin. If you dismiss a message, you can restore it by selecting the **Dismissed messages** tab, selecting the check mark next to the message, and selecting **Restore**. <br/> |
