...
Message center presents a view of all active messages in a table format, by default showing the most recent message at the top of the list. You can select a tab to see **All active messages**, **High importance** messages, **Unread messages**, and **Dismissed messages**. And you can use the **Filter** drop-down menu to see all the messages in a specific message category.
