...
To open Message center, in the Microsoft 365 admin center, go to **Health** \> **Message center**, or click the Message center card on the ** Home ** dashboard. The dashboard card always displays the last three messages that we posted and links to the full Message center page. 
