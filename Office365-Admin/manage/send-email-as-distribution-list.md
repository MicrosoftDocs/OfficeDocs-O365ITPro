...
4. At the bottom of the message, click the More arrow \> **Show from**.<br/> ![Click the More arrow, and then click Show From](../media/534f13b7-9f15-48ea-8835-ea2ed1863ece.png)
...
6. Then type the distribution list address such as support@contoso.com, and send the message. The next time you reply from the distribution list, its address will appear as an option in the From drop down.<br/>![The alias of the shared mailbox appears in the FROM drop down box.](../media/f7632a9a-9cab-446c-9e37-23ef50c5b975.png)
