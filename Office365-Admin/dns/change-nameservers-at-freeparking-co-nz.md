...
Here's what you need to do. (Need more help? [Still need help?](change-nameservers-at-freeparking-co-nz.md#BKMK_NeedHelp).)
  
- [Add a TXT record for verification](change-nameservers-at-freeparking-co-nz.md#BKMK_verify)
    
- [Change your domain's nameserver (NS) records](change-nameservers-at-freeparking-co-nz.md#BKMK_nameservers)
