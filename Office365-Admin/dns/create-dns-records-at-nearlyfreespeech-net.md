...
4. In the boxes for the new record, type or paste the values from the following table.
    ...
    |**Name**|**Type**|**Data**|**TTL**|
    |:-----|:-----|:-----|:-----|
    |(Leave this field empty.)  <br/> |MX  <br/> |0  *\<domain-key\>*  .mail.protection.outlook.com.  <br/> **This value MUST end with a period (.)** <br/> The **0** is the MX priority value. Add it to the beginning of the MX value, separated from the remainder of the value by a space.  <br/> **Note:** Get your \<*domain-key*\> from your Office 365 account. > [How do I find this?](../get-help-with-domains/information-for-dns-records.md)          |3600  <br/> |
...
4. Add the first of the CNAME records.
    ...
    |enterpriseenrollment  <br/> |CNAME  <br/> |enterpriseenrollment-s.manage.microsoft.com  <br/> **This value MUST end with a period (.)** <br/> |3600  <br/> |
